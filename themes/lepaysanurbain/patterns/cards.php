 ...
 */
?>
<!-- wp:group {"align":"full","backgroundColor":"ecru","className":"lpu-card-grid lpu-motif lpu-motif-1-bandeau","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull lpu-card-grid lpu-motif lpu-motif-1-bandeau has-ecru-background-color has-background">
	...
	<div class="wp-block-columns alignwide lpu-card-grid__columns">
		...
		<div class="wp-block-column lpu-card">
			<!-- wp:image {"url":"/wp-content/themes/lepaysanurbain/assets/images/pattern-placeholder.svg","alt":"","linkDestination":"none"} -->
			<figure class="wp-block-image"><img src="/wp-content/themes/lepaysanurbain/assets/images/pattern-placeholder.svg" alt="" /></figure>
			<!-- /wp:image -->
