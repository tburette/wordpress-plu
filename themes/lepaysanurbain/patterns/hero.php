...
<div class="wp-block-cover alignfull lpu-band lpu-hero has-vert-fonce-background-color has-background" style="padding-top:clamp(5rem, 12vw, 9rem);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--xl);padding-left:var(--wp--preset--spacing--lg)">
