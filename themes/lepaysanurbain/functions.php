...
// can change the arguments passed to create the block type
// there is also 'block_type_metadata' which modify the metadata (the data from
// block.json)
// when creating a block, the order is : 
// - read metadata from block.json
// - 'block_type_metadata' filter to change metadata
// - turn metadata to args
// - 'register_block_type_args' filter to change args
// - register_block_type() with the args
...
*/
// disabled : should make the group a <li> instead
// add_filter('block_core_navigation_listable_blocks', function ($blocks) {
// 	$blocks[] = 'core/group';
// 	return $blocks;
// });

// debug, show in logs what markup is generated by wordpress for all the xxx 
// blocks ( render_block_xxx )
